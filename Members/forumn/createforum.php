...
<?php
$id=$_SESSION['user_id'];
$resu= mysql_query("select * from tb_consortium_members where member_id='$id'",$con);
...
<div class="element-input"><label class="title"></label><div class="item-cont"><input class="large" type="text" name="id" value=<?php echo $id1; ?> required="required" disabled /><span class="icon-place"></span></div></div>
	<div class="element-input"><label class="title"></label><div class="item-cont"><input class="large" type="text"  name="name" value=<?php echo $name; ?> required="required" placeholder="NAME"/><span class="icon-place"></span></div></div>
